...
const MeetingRoom = () => {
  ...
  return (
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white'>
      ...
      <div className='fixed bottom-0 flex w-full items-center justify-center gap-5 flex-wrap mb-[10px]'>
            ...
            {["Grid", "Speaker-Left", 'Speaker-Right'].map((item, index) => {
              return <div key={index}>
                <DropdownMenuItem className="cursor-pointer"
                  onClick={() => setlayout(item.toLowerCase() as CallLayout)}>{item}</DropdownMenuItem>
